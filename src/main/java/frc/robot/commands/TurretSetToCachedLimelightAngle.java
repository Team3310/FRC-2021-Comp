...
public class TurretSetToCachedLimelightAngle extends ExtraTimeoutCommand
{
    private final Turret turret;
    private final Limelight limelight;
    private boolean targetFound;

    public TurretSetToCachedLimelightAngle(Turret subsystem)
    {
    ...
    public void initialize() {
        ...
        if (limelight.isOnTarget()) {
            ...
            turret.setTurretMotionMagicPositionRelative(-limelight.getTx() + turret.getTurretCachedLimelightAngle());
            resetExtraOneTimer();
