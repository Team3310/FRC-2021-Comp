...
public class ShooterTestShot extends ParallelCommandGroup {

    public ShooterTestShot(Shooter shooter, Magazine magazine, Turret turret) {
        addCommands(
                ...
                new ShooterSetRPM(shooter, Constants.SHOOTER_TEST_RPM, Constants.SHOOTER_TEST_RPM),
 ...
 //               new TurretSetCachedLimelightOffset(turret, Constants.LIMELIGHT_OFFSET_MEDIUM_SHOT_DEGREES),
                new HoodSetAngle(shooter, Constants.HOOD_TEST_ANGLE_DEGREES-5),
                new HoodSetAngle(shooter, Constants.HOOD_TEST_ANGLE_DEGREES),
                new SequentialCommandGroup(
                        new TurretSetToGyroAngle(turret, 0),
