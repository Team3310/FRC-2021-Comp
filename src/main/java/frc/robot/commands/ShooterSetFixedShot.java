...
public class ShooterSetFixedShot extends ParallelCommandGroup {
    ...
    public ShooterSetFixedShot(Shooter shooter, Magazine magazine, Turret turret, ShooterParams params) {
        addCommands(
