...
public class ShooterAutoShortShotTrack extends SequentialCommandGroup {

    public ShooterAutoShortShotTrack(Shooter shooter, Magazine magazine, Turret turret, double magazineRotations) {
        addCommands(
                ...
                new ParallelCommandGroup(
                        ...
                        new HoodSetAngle(shooter, Constants.HOOD_AUTON_SHORT_ANGLE_DEGREES)
                ),
                new TurretSetToLimelightAngle(turret, Constants.LIMELIGHT_OFFSET_AUTON_SHORT_SHOT_DEGREES),
