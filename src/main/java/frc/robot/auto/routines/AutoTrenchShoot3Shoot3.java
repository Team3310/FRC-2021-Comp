...
public class AutoTrenchShoot3Shoot3 extends SequentialCommandGroup {
...
//                new ShooterAutoShortShotTrack(mShooter, mMagazine, mTurret, Constants.MAGAZINE_SHOOT_AUTO_ROTATIONS_DEGREES_6_ROTATIONS),
                ...
                new RamseteCommand(
                        mTrajectories.getTrench3BallV2(),
                        mDrive::getPose,
                ...
                new ParallelCommandGroup(
                        new RamseteCommand(
                                mTrajectories.getToMediumFrom3TrenchV2(),
                                mDrive::getPose,
                                new RamseteController(Constants.kRamseteB, Constants.kRamseteZeta),
                                new SimpleMotorFeedforward(Constants.ksVolts,
                                        Constants.kvVoltSecondsPerMeter,
