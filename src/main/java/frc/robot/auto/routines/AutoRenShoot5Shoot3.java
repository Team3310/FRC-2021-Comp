...
public class AutoRenShoot5Shoot3 extends SequentialCommandGroup {
    ...
    public AutoRenShoot5Shoot3() {
        ...
        addCommands(
                new ResetAllHomeAuto(mDrive, mTurret, mMagazine, mShooter, mClimb, new Pose2d(Units.inchesToMeters(136), Units.inchesToMeters(-95), new Rotation2d(0))),
                ...
                new RamseteCommand(
                        mTrajectories.getFirst2BallsRend(),
                        mDrive::getPose,
                ...
                new StopTrajectory(),
                new RamseteCommand(
                        mTrajectories.getToShootFromRend(),
                        mDrive::getPose,
                        new RamseteController(Constants.kRamseteB, Constants.kRamseteZeta),
                        new SimpleMotorFeedforward(Constants.ksVolts,
                                Constants.kvVoltSecondsPerMeter,
                ...
                new RamseteCommand(
                        mTrajectories.getRend3BallTrajectory(),
                        mDrive::getPose,
                        new RamseteController(Constants.kRamseteB, Constants.kRamseteZeta),
                        new SimpleMotorFeedforward(Constants.ksVolts,
                                Constants.kvVoltSecondsPerMeter,
                 ...
                 new StopTrajectory(),
                new RamseteCommand(
                        mTrajectories.getRend3BallTrajectoryReverse(),
                        mDrive::getPose,
                        new RamseteController(Constants.kRamseteB, Constants.kRamseteZeta),
                        new SimpleMotorFeedforward(Constants.ksVolts,
                                Constants.kvVoltSecondsPerMeter,
